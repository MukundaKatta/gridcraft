    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 pt-20 pb-20 text-center sm:pt-28">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-neutral-600 sm:text-xl">
            Plan six months of posts visually. See your grid before you post it. Never break the
            aesthetic again.
          </p>
      ...
      <section id="demo" className="border-y border-neutral-200 bg-neutral-50 py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12">
            <div className="mx-auto max-w-xs grid grid-cols-3 gap-1">
              <div className="aspect-square bg-gradient-to-br from-rose-200 to-rose-400" />
              <div className="aspect-square bg-gradient-to-br from-amber-100 to-amber-300" />
              <div className="aspect-square bg-gradient-to-br from-rose-300 to-pink-400" />
              <div className="aspect-square bg-gradient-to-br from-rose-100 to-amber-200" />
              <div className="aspect-square bg-gradient-to-br from-amber-300 to-rose-300" />
              <div className="aspect-square bg-gradient-to-br from-rose-200 to-pink-300" />
              <div className="aspect-square bg-gradient-to-br from-amber-200 to-orange-300" />
              <div className="aspect-square bg-gradient-to-br from-rose-300 to-rose-400" />
              <div className="aspect-square bg-gradient-to-br from-pink-200 to-rose-300" />
            </div>
            <p className="mt-4 text-center text-sm text-neutral-500">
              Six months of posts. Aesthetic locked in.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-12 sm:grid-cols-3">
            <div>
              ...
              <h3 className="mt-4 text-lg font-semibold tracking-tight">Drag and drop</h3>
              <p className="mt-2 leading-relaxed text-neutral-600">
                Rearrange posts until the grid flows. Save layouts. Undo freely.
              </p>
            </div>
            <div>
              <div className="text-3xl">🖼️</div>
              <h3 className="mt-4 text-lg font-semibold tracking-tight">Auto color-matched</h3>
              <p className="mt-2 leading-relaxed text-neutral-600">
                Suggests edits to keep your palette consistent across posts.
              </p>
            </div>
            <div>
              <div className="text-3xl">📆</div>
              <h3 className="mt-4 text-lg font-semibold tracking-tight">Schedules natively</h3>
              <p className="mt-2 leading-relaxed text-neutral-600">
                Once the grid is locked, we queue everything into your Meta Business Suite.
              </p>
            </div>
          </div>
        </div>
